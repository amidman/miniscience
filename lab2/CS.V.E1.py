...
class CalcMesh:
    ...
    def move(self, tau):
        ...
        self.velocity[0] = 100*self.nodes[0]*np.sin(1256*self.time)-100*self.nodes[2]*np.sin(1256*self.time)
    ...
    def snapshot(self, snap_number):
        ...
        writer.SetFileName("CS.V.E1-step-" + str(snap_number) + ".vtu")
        writer.Write()
...
try:
    ...
    gmsh.merge(os.path.join(path, 'CS.V.E1.stl'))
except:
